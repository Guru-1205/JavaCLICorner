...
// 4 access modifiers -> public (can be accessed from the anywhere within the project),
// private(can be accessed only within the class),
// protected (1st can be accessed within same folder or 2nd subclasses can access and it can also exist on different folder) ,
        // default (can be accessed within same package/folder)
