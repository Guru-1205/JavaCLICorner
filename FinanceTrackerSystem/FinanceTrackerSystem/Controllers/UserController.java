...
import FinanceTrackerSystem.Models.UserProfile;
 ...
 * <h2>Dependencies</h2>
 * <ul>
 * <li>{@link FinanceTrackerSystem.Models.User} - The user model being
 * managed.</li>
 * <li>{@link FinanceTrackerSystem.Models.UserProfile} - The profile details for
 * each user.</li>
 * <li>{@link FinanceTrackerSystem.Models.enums.UserType} - Enum for user type
 * (ADMIN, REGULAR).</li>
 * </ul>
 *
 * <h2>Thread Safety</h2>
